...
public slots:
    ...
    void set_externalArrays(const qreal *pointer1, const qreal *pointer2, quint16 length);
    ...
    void updateStrings(qreal value, bool objectMeasurementFlag);
    void setEnableGradient(bool value);
    void setDrawSecondArray(bool value);
...
private:  
    ...
    //variable list
        //data to draw
    const qreal *pt_Array1;
    const qreal *pt_Array2;
    ...
    bool f_drawsecondarray;
    bool f_enablegradient;
};
